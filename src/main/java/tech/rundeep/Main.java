 ...
 * http://www.jb51.net/article/101910.htm
 */
public class Main {
    public static void main(String[] args) throws Exception {
        System.out.println("Starting...");
        new Main().testReadByDoc();

    }

    //简单读docx
    public static void readAndWriterTest4() throws IOException {
        File file = new File("D:\\模板.docx");
        String str = "";
        try {
    ...
    public void testReadByDoc() throws Exception {
        InputStream is = new FileInputStream("D:\\模板.doc");
        ...
        //System.out.println(doc.getDocProperties().toString());
...
//            }
    ...
    private void printInfo(Range range) {
        ...
        System.out.println("总段落数："+paraNum);
